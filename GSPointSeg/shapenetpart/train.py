...
from gspointpartseg import GSPointPartSeg
import random, os
from time import time, sleep
from config import gspoint_args, batch_size, learning_rate as lr, label_smoothing as ls, epoch, warmup
...
model = GSPointPartSeg(gspoint_args).cuda()
