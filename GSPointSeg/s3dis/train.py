...
from gspointsemseg import GSPointSemSeg
from time import time, sleep
from config import s3dis_args, s3dis_warmup_args, gspoint_args, batch_size, learning_rate as lr, epoch, warmup, label_smoothing as ls
...
model = GSPointSemSeg(gspoint_args).cuda()
