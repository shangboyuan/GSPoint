...
gspoint_args.ks = s3dis_args.k
gspoint_args.depths = [4, 4, 8, 4]
gspoint_args.dims = [64, 128, 256, 512]
gspoint_args.nbr_dims = [32, 32]
gspoint_args.head_dim = 256
gspoint_args.num_classes = 13
...
gspoint_args.bn_momentum = 0.02
gspoint_args.act = nn.GELU
gspoint_args.mlp_ratio = 2
gspoint_args.use_cp = False

gspoint_args.cor_std = [1.6, 3.2, 6.4, 12.8]
